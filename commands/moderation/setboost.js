...
module.exports = {
    config:{
    name: 'setboost',
    aliases: ['setboostchannel', 'boostchannel'],
    description: 'set the channel + msg for a boost!',
    usage: 'setboost <channel> <msg>',
    },
    ...
    const embed3 = new MessageEmbed()
        ...
        if (!message.member.permissions.has("ADMINISTARTOR")) return message.channel.send(embed3)
